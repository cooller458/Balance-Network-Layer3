...
contract Bridge is Initializable, DelegateCallAware, IBridge {
    ...
    mapping (address => InOutInfo) public allowedDelayedInboxedMap;
    mapping (address => InOutInfo) public allowedOutboxesMap;
    ...
    uint256 public ovveride sequencerReportedSubMessageCount;
    ...
    function allowedDelayedInboxes(address inbox) external view returns (bool) {
        return allowedDelayedInboxedMap[inbox].allowed;
    }
    function allowedOuboxes(address outbox) external view returns(bool) {
    ...
    ) external onlySequencerInbox returns (
